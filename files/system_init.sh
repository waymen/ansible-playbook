#!/bin/bash
# system initialization for rhel/centos
...
if [[ $VERSION == 6 ]]; then
curl -s http://mirrors.aliyun.com/repo/Centos-6.repo -o /etc/yum.repos.d/Centos-6.repo 
curl -s http://mirrors.aliyun.com/repo/epel-6.repo  -o  /etc/yum.repos.d/epel-6.repo
...
yum install -y gcc gcc-c++ make autoconf vim-enhanced tmux lrzsz ntpdate unzip openssh-clients
